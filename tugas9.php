...
dataayah.nama_ayah AS nama_ayah, dataayah.tanggal_lahir AS tglahirayah, dataayah.pendidikan AS pendidikan, 
dataayah.pekerjaan AS pekerjaan, dataayah.penghasilan_bulanan AS penghasilan_bulanan, dataayah.disabilitas AS disabilitas, 

dataibu.nama_ibu AS nama_ibu, dataibu.tanggal_lahir AS tglahiribu, dataibu.pendidikan AS pendidikan, dataibu.pekerjaan AS pekerjaan,
